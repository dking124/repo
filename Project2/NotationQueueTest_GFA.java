...
public class NotationQueueTest_GFA {
	...
	public void testDequeueStudent() {
		try {
			...
			assertEquals(Double.valueOf("4.0"), doubleQ.dequeue());
			assertEquals(Double.valueOf("6.0"), doubleQ.dequeue());
		}
		catch (QueueUnderflowException e){
			assertTrue("This should have caused an QueueUnderflowException", true);
		}
	...
	public void testEnqueueStudent() {
		...
		assertEquals(true, doubleQ.enqueue(7.0));
	...
	public void testToStringStudent() throws QueueOverflowException{
		...
		doubleQ.enqueue(5.0);
		assertEquals("2.04.06.05.0", doubleQ.toString());
		doubleQ.enqueue(7.0);
		assertEquals("2.04.06.05.07.0", doubleQ.toString());
	}
