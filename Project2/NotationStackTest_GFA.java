...
public class NotationStackTest_GFA {
	...
	public void testPopStudent() {
		try {
			assertEquals(Double.valueOf("6.0"), doubleS.pop());
			assertEquals(Double.valueOf("4.0"), doubleS.pop());
	...
	public void testPushStudent() {
		try {
			...
			assertEquals(true, doubleS.push(7.0));
	...
	public void testToStringStudent() throws StackOverflowException {
		...
		doubleS.push(5.0);
		assertEquals("2.04.06.05.0", doubleS.toString());
		doubleS.push(7.0);
		assertEquals("2.04.06.05.07.0", doubleS.toString());
	}
